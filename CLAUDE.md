...
- **Bundles B/C/D DEFERRED** until Bundle A tester validation completes (24-72 hr stability window). Scope per `docs/plans/2026-05-11-bundle-a-p0-fixes-design.md`: **B** = Arabic deep clean; **C** = visual polish (camera 2-product limit, category chip emoji→icon glyphs, logo placement, Cal-AI animation polish); **D** = perf (bundle size, Reanimated profiling, SVG audit). Branch.io/AppsFlyer deep-link install survival straddles C/D. Don't open new feature work mid-audit.
