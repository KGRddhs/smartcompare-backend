...
- **PENDING TRIM:** this file is oversized (~600 lines / >100KB). The 2026-06/07 arc blocks and the SUPERSEDED 2026-08-25/26 Active-runtime block should be collapsed into `docs/` next session; D4 deliberately added only the flag table, the runbook and this block.

## Active runtime (wave-3 global hardening + fix wave — ✅ MERGED TO MAIN `6205a7c` + DEPLOYED, 2026-08-30)

**The fragrance branch below is MERGED** (FF `8adaefb..4c7abf6`, 22 commits, then `6205a7c` tooling), deployed to Railway, `/health` 200. Everything the 2026-08-25/26 block below records as "on the branch" is now IN PROD. What shipped on top of it, this session:
