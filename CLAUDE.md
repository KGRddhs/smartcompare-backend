...
Applied: 010 (RLS), 011 (freemium + audit log), 012 (product data tables), 013 (demographics + cohort views, applied 2026-05-05 via MCP after a 2026-05-04 SQL Editor rollback), 014 (referral system), 015 (push tokens), 016 (referral invite privacy JSONB), 017 (share_token VARCHAR→TEXT).
