...
**Both holes closed → genuine-winner invariant now complete on both flag paths. Awaiting team-lead re-verify (quick code-read) → merge v2 (4th) → L1 (5th) → capture → I run offline sweep.**
