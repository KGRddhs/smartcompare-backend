 ...
 * (DEFAULT_COMPARISON_STAGE_STEP_MS). The FREEZE contract this file exists
 * to protect is unchanged and every assertion below still asserts it — only
 * the clock the walk is driven on moved.
 */
