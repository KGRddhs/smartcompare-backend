...
|---|---|---|---|
| **PhoneMockup** | Step01Welcome | Stylized iOS-shape SVG outline w/ Qaren wordmark inside, emerald accent dot bottom-right. ~180×280px. | Subtle 0.95→1.0 scale-in on mount (320ms cubic-bezier); idle. |
